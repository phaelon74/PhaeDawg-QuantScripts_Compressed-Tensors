"""
Qwen3.6-27B-Architect-Polaris2-Fable-B-F451 W8A16 PTQ (Post-Training Quantization)
...
parser = argparse.ArgumentParser(
    description=(
        "Run W8A16 PTQ on nightmedia/Qwen3.6-27B-Architect-Polaris2-Fable-B-F451 "
