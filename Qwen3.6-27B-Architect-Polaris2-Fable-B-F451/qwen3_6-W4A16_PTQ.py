"""
Qwen3.6-27B-Architect-Polaris2-Fable-B-F451 W4A16 PTQ (Post-Training Quantization)

Dense (non-MoE) Qwen3.6-27B VLM — nightmedia/Qwen3.6-27B-Architect-Polaris2-Fable-B-F451
  ...
  - W4A16 preset: INT4 per-channel / group weights, FP16/BF16 activations
...
parser = argparse.ArgumentParser(
    description=(
        "Run W4A16 PTQ on nightmedia/Qwen3.6-27B-Architect-Polaris2-Fable-B-F451 "
        "(dense Qwen3.6-27B VLM). No calibration data needed."
    )
)
...
# Quantization recipe
# =========================
# W4A16 preset: INT4 weights, activations untouched.
# Dense non-MoE: still ignore visual / linear_attn / mtp (config has all three).
