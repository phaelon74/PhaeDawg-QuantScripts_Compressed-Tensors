...
export VLLM_EXL3_EXT_PATH="${EXL3_EXT_PATH:-$EXL3_ROOT/build/exllamav3_ext}"
export VLLM_EXL3_SKIP_VERSION_GUARD=1
export VLLM_EXL3_CROSSOVER_JSON="${EXL3_CROSSOVER_JSON:-$EXL3_ROOT/manifests/sm86_crossover.json}"
...
export VLLM_EXL3_QUANT_CONFIG="$MODEL_DIR/quantization_config.json"
...
echo "  VLLM_EXL3_QUANT_CONFIG=$VLLM_EXL3_QUANT_CONFIG"
